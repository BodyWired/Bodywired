...
public interface RecetteDao {
	...
	Integer modifierIngredientRecette(@Param("rec") Recette ingredient, @Param("qte") int qte,
			@Param("rec_concernee") Recette recette);
	...
	Integer modifierIngredientAliment(@Param("ali") Aliment ingredient, @Param("qte") int qte,
			@Param("rec_concernee") Recette recette);
